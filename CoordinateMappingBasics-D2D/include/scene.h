...
_______________________________________________________________*/
	...
	struct _color_rgb_uchar {
		...
		_color_rgb_uchar const &_color_rgb_uchar::operator+=( float _s ) { return *this += (unsigned char)_s; }
		_color_rgb_uchar const &_color_rgb_uchar::operator+=( double _s ) { return *this += (unsigned char)_s; }
		...
		_color_rgb_uchar const &_color_rgb_uchar::operator*=( double _s ) { return *this *= (unsigned char)_s; }
		_color_rgb_uchar operator*( int _s ) { return _color_rgb_uchar( *this ) *= _s; }
		_color_rgb_uchar operator*( float _s ) { return _color_rgb_uchar( *this ) *= (unsigned char)_s; }
		_color_rgb_uchar operator*( double _s ) { return _color_rgb_uchar( *this ) *= (unsigned char)_s; }
